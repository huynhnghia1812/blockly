...
goog.provide('Blockly.Constants.Loop');

goog.require('Blockly.Blocks');
goog.require('Blockly');

Blockly.Constants.Loop.Colour = 290;
...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  	// Block for repeat n times (external number).
  	{
	    ...
	    "nextStatement": null,
	    "colour": Blockly.Constants.Loop.Colour,
 ...
 * @readonly
 */
Blockly.Constants.Loop.WHILE_UNTIL_TOOLTIPS = {
...
Blockly.Extensions.register('controls_whileUntil_tooltip',
    Blockly.Extensions.buildTooltipForDropdown(
        'MODE', Blockly.Constants.Loop.WHILE_UNTIL_TOOLTIPS));
 ...
 * @readonly
 */
Blockly.Constants.Loop.BREAK_CONTINUE_TOOLTIPS = {
...
Blockly.Extensions.register('controls_flow_tooltip',
    Blockly.Extensions.buildTooltipForDropdown(
        'FLOW', Blockly.Constants.Loop.BREAK_CONTINUE_TOOLTIPS));
 ...
 * @readonly
 */
Blockly.Constants.Loop.CUSTOM_CONTEXT_MENU_CREATE_VARIABLES_GET_MIXIN = {
  /**
 ...
 * @readonly
 */
Blockly.Constants.Loop.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
  /**
